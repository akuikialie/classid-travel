                            ...
                            <div class="stepper-item mark-completed" data-kt-stepper-element="nav">
                                ...
                                <div class="stepper-wrapper">
                                    ...
                                    <div class="stepper-label">
                                        ...
                                        <div class="stepper-desc">Setup selesai</div>
                                    </div>
                                    <!--end::Label-->
                                </div>
                                <!--end::Wrapper-->
                            ...
                            <div class="current" data-kt-stepper-element="content">
                                <div class="w-100" style="overflow:hidden; overflow-y:scroll; height:320px;">
                                            ...
                                            @forelse ($plans as $plan)
                                                <div class="col">
                                                    ...
                                                    <span class="form-check form-check-custom form-check-solid">
                                                        ...
                                                        <!--begin::Label-->
                                                        <label for="{{ $plan->key }}"
                                                            class="d-flex align-items-center fs-5 fw-semibold ms-2">
                                    ...
                                    <div class="fv-row mb-10">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <textarea name="description" class="form-control form-control-lg form-control-solid" rows="3">{{ old('description') }}</textarea>
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="fv-row mb-10">
                                        ...
                                        <!--begin::Input-->
                                        <input type="number" class="form-control form-control-lg form-control-solid"
                                            name="amount" placeholder="Biaya Paket" value="{{ old('amount') }}" />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                                ...
                                                @forelse ($facilities as $facility)
                                                    ...
                                                    <div class="d-flex align-items-center mb-2">
                                                        ...
                                                        <div class="flex-grow-1" for="facilities">
                                                            ...
                                                            <span
                                                                class="text-muted fw-semibold d-block">{{-- --}}</span>
                                                        </div>
                                                        <!--end::Description-->
                                                        <span
                            ...
                            <div class="d-flex flex-stack pt-10">
                                ...
                                <div>
                                    <button class="btn btn-lg btn-primary" data-kt-stepper-action="submit"
                                        onclick="$('#kt_modal_create_app_form').submit()">
