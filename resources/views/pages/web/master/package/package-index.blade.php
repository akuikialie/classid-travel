  ...
  <script type="text/javascript">
    $(document).ready(function () {
      ...
      $("#setup-button").click(function (e) {
        e.preventDefault();
        $.ajax({
          url: "{{ route('master.package.create') }}",
          type: "GET",
      ...
      $('.btn-edit-modal').click(function (e) {
        ...
        let url_edit = "{{ route('master.package.edit', ':id') }}";
      ...
      $('.btn-itinerary-setup').click(function (e) {
        e.preventDefault();
        var id = $(this).attr("data-id");
        let urlSetupItinerary = "{{ route('master.package.itinerary-setup.create', ':id') }}";
              ...
              <td class="text-end">
                ...
                <div
                  ...
                  @if ($package->jamaah_count < 1)
                    <!--begin::Menu item-->
                    <form action="{{ route('master.package.destroy', $package->id) }}"
