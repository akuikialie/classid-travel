@php use App\Enums\FacilityType; @endphp
...
@section('page-scripts')
    ...
    <script src="{{ asset('web/js/based/datatables/facility-datatable.js') }}"></script>
@endsection
                                ...
                                <form id="form-filter">
                                    ...
                                    <div class="px-7 py-5" data-kt-user-table-filter="form">
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <select name="type" class="form-select form-select-solid fw-bold"
                                                data-kt-select2="true" data-placeholder="Select option"
                                                data-allow-clear="true" data-kt-user-table-filter="role"
                                                data-hide-search="true">
                                                <option></option>
                                                @foreach (FacilityType::cases() as $type)
                                                    <option value="{{ $type->keyValue() }}">
                                                        {{ \Illuminate\Support\Str::ucfirst($type->keyValue()) }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <button type="button" id="apply-filter" class="btn btn-primary fw-semibold px-6"
