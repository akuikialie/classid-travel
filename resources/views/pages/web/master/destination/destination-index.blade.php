    ...
    $(document).ready(function () {
      ...
      $("#setup-button").click(function (e) {
        ...
        $.ajax({
          ...
          url: "{{ route('admin.master.destination.create') }}",
          type: "GET",
      ...
      $('.btn-edit-modal').click(function (e) {
        ...
        let url_edit = "{{ route('admin.master.destination.edit', ':id') }}";
            ...
            <tr>
              ...
              <td class="text-end">
                ...
                <div
                  ...
                  <!--begin::Menu item-->
                  @if ($destination->packages_count < 1)
                    <form action="{{ route('admin.master.destination.destroy', $destination->id) }}"
