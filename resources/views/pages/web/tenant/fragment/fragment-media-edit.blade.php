      ...
      <div class="row mb-8">
        ...
        <div class="col-xl-9 fv-row">
          <input type="text" class="form-control form-control-solid"
                 @if(!config("media-collections.collection_settings.{$param}.is_editable_title"))
                   readonly="readonly"
                 @endif
                 name="collection" value="{{ $param }}"/>
        </div>
      </div>
      <!--end::Row-->
      ...
      <div class="row mb-5">
        ...
        @for($i = 0; $i < config("media-collections.collection_settings.{$param}.max"); $i++)
          @php
            ...
            $currentBanner = collect($media_items)->where('order', $a+1)->last();
            ...
            <div class="col-lg-8">
              ...
              <div class="image-input image-input-outline" data-kt-image-input="true"
                ...
                <div class="image-input-wrapper w-lg-300px h-lg-175px bgi-position-center"
                     style="background-size: 75%; background-image: url({{ $currentBanner?? asset('logo/96w/logo-pict@96px.png') }})"></div>
                ...
                <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-white shadow"
                  ...
                  <!--begin::Inputs-->
                  <input type="file" name="collections[{{$a+1}}]" accept=".png, .jpg, .jpeg"/>
