...
@section('mobile-content')
    ...
    <div class="card card-style">
        <div class="content">
            ...
            <div class="float-start">
                ...
                <p class="font-12 opacity-100">
                    <strong><i
                            class="fa-solid fa-wallet"></i> {{ isset($data['totalSavings']) ? $data['totalSavings'] : 0 }}
                    </strong> <br>
                    <strong><i
                            class="fa-solid fa-wallet"></i> {{ isset($data['totalUsdSavings']) ? $data['totalUsdSavings'] : '~' }}
                    </strong> <br>
                    <small>dari Rp {{ isset($data['targetSavings']) ? $data['targetSavings'] : '~' }}</small>
                </p>
                ...
                <div class="splide__list">
                    ...
                    @for($i = 0; $i < config('media-collections.collection_settings.banners.max'); $i++)
                        ...
                        <div class="splide__slide">
                            <div class="card rounded-l mx-2 text-center shadow-l"
                                 style="background-image: url({{$currentBanner}})" data-card-height="320">
    ...
    <div class="row text-center mb-0">
        <form action="{{ route('perencanaan.check-estimasi') }}" method="get" id="berangkat-langsung"
              class="col-6 pe-2">
