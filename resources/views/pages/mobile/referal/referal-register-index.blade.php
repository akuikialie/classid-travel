        ...
        <form action="{{ route('invite.link-authentication', [$hash, 'register']) }}" method="post">
            ...
            <div class="content mb-0 mt-1">
                <div class="input-style no-borders has-icon validate-field">
                    ...
                    <input type="name" class="form-control validate-name" id="name" name="name" placeholder="Name" value="{{ old('name') }}">
                ...
                <div class="d-flex">
                    <div class="w-50 font-11 pb-2 color-theme opacity-60 pb-3 text-start"><a href="{{ route('invite.link', [$hash, 'login']) }}"
