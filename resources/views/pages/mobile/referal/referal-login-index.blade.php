...
@section('mobile-content')
    ...
    <div class="card card-style">
        <div class="content mt-2 mb-0">
            <form action="{{ route('invite.link-authentication', [$hash, 'login']) }}" method="post">
                @csrf
            ...
            <div class="d-flex">
                <div class="w-50 font-11 pb-2 color-theme opacity-60 pb-3 text-start"><a href="{{ route('invite.link', [$hash, 'register']) }}"
