  ...
  <div class="card card-style">
    <div class="content">
      ...
      <form action="{{ route('profile.change-avatar') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="file-data pb-5 mt-3">
          <input type="file" id="file-upload" name="avatar" class="upload-file bg-highlight shadow-s rounded-s "
                 accept="image/*">
          <p class="upload-file-text color-white">Ganti Profile</p>
        </div>
        <div class="list-group list-custom-large upload-file-data disabled mt-3">
