...
<div id="page">
    ...
    <div class="page-content">
            ...
            <div class="row mb-0">
                <a href="#" class="col-4">
                    <div class="card card-style text-center py-3 mx-0 mb-0">
                        <i class="fa fa-university font-24 color-theme opacity-30"></i>
                        <p class="font-13 font-500 mb-n1 mt-2 color-theme">Withdraw</p>
                    </div>
                </a>
                <a href="#" class="col-4">
                    <div class="card card-style text-center py-3 mx-0 mb-0">
                        <i class="fa fa-exchange-alt font-24 color-theme opacity-30"></i>
                        <p class="font-13 font-500 mb-n1 mt-2 color-theme">Transfer</p>
                    </div>
                </a>
                <a href="#" class="col-4">
                    <div class="card card-style text-center py-3 mx-0 mb-0">
                        <i class="fa fa-arrow-down font-24 color-theme opacity-30"></i>
                        <p class="font-13 font-500 mb-n1 mt-2 color-theme">Request</p>
                    </div>
                </a>
            </div>
        </div>
        ...
        <div class="card card-style">
            <div class="content">
                <h3 class="float-start font-16">Recent Activity</h3>
                ...
                <div class="d-flex">
                    <div>
                        <a href="#" class="icon icon-m bg-green-dark rounded-m shadow-xl"><i class="fa fa-arrow-down"></i></a>
                    </div>
                ...
                <div class="d-flex">
                    <div>
                        <a href="#" class="icon icon-m bg-dark-dark rounded-m shadow-xl"><i class="fab fa-apple font-20"></i></a>
                    </div>
                    <div class="align-self-center ps-3">
                ...
                <div class="d-flex">
                    <div>
                        <a href="#" class="icon icon-m bg-red-dark rounded-m shadow-xl"><i class="fa fa-arrow-up font-20"></i></a>
                    </div>
                    <div class="align-self-center ps-3">
                ...
                <div class="d-flex">
                    <div>
                        <a href="#" class="icon icon-m bg-blue-dark rounded-m shadow-xl"><i class="fa fa-exchange-alt font-20"></i></a>
                    </div>
                    <div class="align-self-center ps-3">
        ...
        <div class="card mt-4 preload-img" data-src="images/pictures/20s.jpg">
            <div class="card-body py-4">
                <h3 class="color-white mb-n1">At a Glance</h3>
                <p class="color-white opacity-60">
                    Your main account balances and expenses.
                </p>
                    ...
                    <div class="content mb-2 mt-3">
                        <div class="d-flex">
                            ...
                            <div class="w-100 align-self-center ps-3">
                                <h6 class="font-14 font-500">Income<span class="float-end color-green-dark">+$3.115</span></h6>
                                <div class="divider mb-2 mt-1"></div>
                                <h6 class="font-14 font-500">Expenses<span class="float-end color-red-dark">-$1.315</span></h6>
                            </div>
                        </div>
                        ...
                        <div class="row mb-0">
                            <div class="col-6 pe-1">
                                <div class="mx-0 mb-3">
                                    ...
                                    <h3 class="color-green-dark font-15 mb-0">+31.2%</h3>
                                </div>
                            </div>
                            <div class="col-6 ps-1">
                                <div class="mx-0 mb-3">
                                    <h6 class="font-13 font-400 mb-0">Expenses</h6>
                                    <h3 class="color-red-dark font-15 mb-0">-14.5%</h3>
                                </div>
                            </div>
                            <div class="col-6 pe-1">
                                <div class="mx-0 mb-3">
                                    <h6 class="font-13 font-400 mb-0">Subscriptions</h6>
                                    <h3 class="color-brown-dark font-15 mb-0">+11.2%</h3>
                                </div>
                            </div>
                            <div class="col-6 ps-1">
                                <div class="mx-0 mb-3">
                                    <h6 class="font-13 font-400 mb-0">Savings</h6>
                                    <h3 class="color-blue-dark font-15 mb-0">$14,500</h3>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="content">
                ...
                <div class="d-flex">
                    <div class="align-self-center">
                        <a href="#" class="icon icon-m bg-green-dark rounded-m shadow-xl"><i class="fa fa-user"></i></a>
                    </div>
                    <div class="align-self-center ps-3">
                ...
                <div class="d-flex">
                    <div class="align-self-center">
                        <a href="#" class="icon icon-m bg-red-dark rounded-m shadow-xl"><i class="fa fa-key"></i></a>
                    </div>
                    <div class="align-self-center ps-3">
        ...
        <div class="content mb-n2">
            <h5 class="float-start font-16 font-500">Account Settings</h5>
            <a class="float-end font-12 color-highlight mt-n1" href="#">View All</a>
            <div class="clearfix"></div>
        </div>
        <div class="content">
