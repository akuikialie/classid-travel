<div id="kt_app_layout_builder" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="app-settings"
    ...
    <div class="card border-0 shadow-none rounded-0 w-100">
        ...
        <div class="card-header bgi-position-y-bottom bgi-position-x-end bgi-size-cover bgi-no-repeat rounded-0 border-0 py-4"
            ...
            style="background-image:url('/metronic8/demo1/assets/media/misc/layout/header-bg.jpg')">
            <!--begin::Card title-->
                    ...
                    <div class="card-body p-0">
                            ...
                            <div class="row" data-kt-buttons="true"
                                ...
                                <div class="col-6">
                                    ...
                                    <label class="form-check-image form-check-success">
                                        ...
                                        <div class="form-check-wrapper">
                                            <img src="/metronic8/demo1/assets/media/misc/layout/demo1-light.png"
                                                class="mw-100" alt="" />
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Check-->
                                ...
                                <div class="col-6">
                                    ...
                                    <label class="form-check-image form-check-success">
                                        <!--begin::Image-->
                                        <div class="form-check-wrapper">
                                            <img src="/metronic8/demo1/assets/media/misc/layout/demo1-dark.png"
                                                class="mw-100" alt="" />
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Check-->
                        ...
                        <div class="form-group">
                            ...
                            <div class="d-flex">
                                ...
                                <div
                                    class="form-check form-check-custom form-check-success form-check-solid form-check-sm me-5">
                                    <input class="form-check-input" type="radio" checked="checked" value="svg"
                        ...
                        <div class="form-group">
                            ...
                            <div class="row gy-3" data-kt-buttons="true"
                                ...
                                <div class="col-6">
                                    <!--begin::Option-->
                                    <label class="form-check-image form-check-success disabled" disabled="disabled"
                                        data-bs-toggle="tooltip" title="This page's tayout can not be changed">
                                        <!--begin::Image-->
                                        <div class="form-check-wrapper">
                                            <img src="/metronic8/demo1/assets/media/misc/layout/dark-sidebar.png"
                                                class="mw-100" alt="" />
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Check-->
                                ...
                                <div class="col-6">
                                    <!--begin::Option-->
                                    <label class="form-check-image form-check-success active disabled active"
                                        disabled="disabled" data-bs-toggle="tooltip"
                                        title="This page's tayout can not be changed">
                                        <!--begin::Image-->
                                        <div class="form-check-wrapper">
                                            <img src="/metronic8/demo1/assets/media/misc/layout/light-sidebar.png"
                                                class="mw-100" alt="" />
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Check-->
                                        <div
                                            ...
                                            <input class="form-check-input" type="radio" checked="checked"
                                                disabled="disabled" value="light-sidebar"
                                                name="layout-builder[layout][app][general][layout]" />
                                            <!--begin::Label-->
                                ...
                                <div class="col-6">
                                    ...
                                    <label class="form-check-image form-check-success disabled" disabled="disabled"
                                        ...
                                        <!--begin::Image-->
                                        <div class="form-check-wrapper">
                                            <img src="/metronic8/demo1/assets/media/misc/layout/dark-header.png"
                                                class="mw-100" alt="" />
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Check-->
                                ...
                                <div class="col-6">
                                    ...
                                    <label class="form-check-image form-check-success disabled" disabled="disabled"
                                        ...
                                        <!--begin::Image-->
                                        <div class="form-check-wrapper">
                                            <img src="/metronic8/demo1/assets/media/misc/layout/light-header.png"
                                                class="mw-100" alt="" />
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Check-->
