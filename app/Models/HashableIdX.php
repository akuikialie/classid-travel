...
trait HashableIdX
{
    ...
    public function scopeByHash(Builder $query, string|null $hash, string|null $keyName = null)
    {
        if (!$hash) return null;
    ...
    public function scopeByHashOrFail(Builder $query, string|null $hash, string|null $keyName = null)
    {
