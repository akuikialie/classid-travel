    ...
    !function () {
      ...
      if (e) {
        var t = {self: null, rendered: !1}, a = function () {
          ...
          var a = KTUtil.getCssVariableValue("--kt-gray-500"), o = KTUtil.getCssVariableValue("--kt-gray-200"),
      ...
      if (e) {
        var t = {self: null, rendered: !1}, a = function () {
          parseInt(KTUtil.css(e, "height"));
          var a = KTUtil.getCssVariableValue("--kt-gray-500"), o = KTUtil.getCssVariableValue("--kt-gray-200"),
            r = KTUtil.getCssVariableValue("--kt-success"), s = KTUtil.getCssVariableValue("--kt-success-light"),
            l = KTUtil.getCssVariableValue("--kt-warning"), i = KTUtil.getCssVariableValue("--kt-warning-light"), n = {
      ...
      if (e) {
        var t = {self: null, rendered: !1}, a = function () {
          parseInt(KTUtil.css(e, "height"));
          var a = KTUtil.getCssVariableValue("--kt-gray-500"), o = KTUtil.getCssVariableValue("--kt-gray-200"), r = {
      ...
      if (e) {
        var t = {self: null, rendered: !1}, a = function () {
          parseInt(KTUtil.css(e, "height"));
          var a = KTUtil.getCssVariableValue("--kt-gray-500"), o = KTUtil.getCssVariableValue("--kt-gray-200"),
            r = KTUtil.getCssVariableValue("--kt-primary"), s = KTUtil.getCssVariableValue("--kt-primary-light"), l = {
              series: [{name: "Net Profit", type: "bar", stacked: !0, data: [40, 50, 65, 70, 50, 30]}, {
                name: "Revenue",
                type: "bar",
                stacked: !0,
      ...
      if (e) {
        var t = {self: null, rendered: !1}, a = function () {
          var a = parseInt(KTUtil.css(e, "height")), o = KTUtil.getCssVariableValue("--kt-gray-500"),
            r = KTUtil.getCssVariableValue("--kt-gray-200"), s = KTUtil.getCssVariableValue("--kt-gray-300"),
            l = KTUtil.getCssVariableValue("--kt-warning"), i = KTUtil.getCssVariableValue("--kt-warning-light"),
            n = KTUtil.getCssVariableValue("--kt-success"), d = KTUtil.getCssVariableValue("--kt-success-light"),
      ...
      [].slice.call(e).map((function (e) {
        ...
        if (e) {
          var a = e.getAttribute("data-kt-chart-color"), o = KTUtil.getCssVariableValue("--kt-" + a),
            r = KTUtil.getCssVariableValue("--kt-" + a + "-light"), s = KTUtil.getCssVariableValue("--kt-gray-700");
          new ApexCharts(e, {
            series: [74],
      ...
      var e, t = document.querySelectorAll(".mixed-widget-12-chart"), a = KTUtil.getCssVariableValue("--kt-gray-500"),
      ...
      [].slice.call(t).map((function (t) {
        if (e = parseInt(KTUtil.css(t, "height")), t) {
          var a = KTUtil.getCssVariableValue("--kt-gray-800"), o = KTUtil.getCssVariableValue("--kt-gray-300");
          new ApexCharts(t, {
            series: [{name: "Net Profit", data: [15, 25, 15, 40, 20, 50]}],
      ...
      if ("undefined" != typeof FullCalendar && document.querySelector("#kt_calendar_widget_1")) {
        var e = moment().startOf("day"), t = e.format("YYYY-MM"), a = e.clone().subtract(1, "day").format("YYYY-MM-DD"),
          o = e.format("YYYY-MM-DD"), r = e.clone().add(1, "day").format("YYYY-MM-DD"),
